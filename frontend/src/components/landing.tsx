        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <Button onClick={async () => {
              ...
              {uploadId ? deployed ? `Deployed (${uploadId})` : `Deploying (${uploadId})` : uploading ? "Uploading..." : "Upload"}
            </Button>
          </div>
        </CardContent>
      </Card>
      {deployed && <Card className="w-full max-w-md mt-8">
        ...
        <CardContent>
          ...
          <Button className="w-full" variant="outline">
            <a href={`http://${uploadId}.localhost:3001/index.html`} className="w-full" target="_blank">
              Visit Website
            </a>
          </Button>
        </CardContent>
